...
<header class="header">
    <nav class="navbar" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
            <a href="/"> <img src="<c:url value="/resources/images/logo.png" />" width="60" height="60">
            </a>
        </div>
        <div class="navbar-menu">
            ...
            <div class="navbar-end">
                <a class="navbar-item" href="/"> Зарегистрироваться </a> <a
                    class="navbar-item" href="/"> Залогиниться </a>
            </div>
        </div>
    </nav>
</header>
<main class="conatiner main">
    <ul class="main__button-list">
        <li class="main__button-list-item">
            <button class="button make-payment-js">Сделать платёж</button>
        </li>
        <li class="main__button-list-item">
            <button class="button payment-list-js">Список платежей</button>
        </li>
        <li class="main__button-list-item">
            <button class="button make-declaration-js">Подать заявку</button>
        </li>
        <li class="main__button-list-item">
    ...
    <div class="content">
        <form class="payment-form disp-none">
            <h3 class="payment-form__title">Форма Оплаты</h3>
            <label class="payment-form__row"> <span
                    class="payment-form__input-title">Услуга</span> <select
                    class="dropdown">
...
<footer class="footer">
		<span class="footer__copyright"> &copy; 2019 Lorem Ipsum - это
